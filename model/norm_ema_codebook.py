# EMA codebook update with L2 normalization and K-means
# Ref: BeiT v2: https://arxiv.org/abs/2208.06366
...
class NormEMAVectorQuantizer(nn.Module):
    ...
    def forward(self, z):
        ...
        z = l2norm(z)
        z_flattened = z.reshape(-1, self.codebook_dim) # bdhw, c
        ...
        return_dict = dict(embeddings=z_q, encodings=encoding_indices,
